...
import { BarOrder, CreditNote } from '../../types';
...
export const OrdersFinanceDashboard: React.FC = () => {
  ...
  const [activeFinanceTab, setActiveFinanceTab] = useState<'live_orders' | 'monthly_sales' | 'credit_notes'>('live_orders');
  ...
  return (
    <div className="space-y-5 sm:space-y-6 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-2 border-b border-white/10">
        <div>
          <h2 className="text-xl sm:text-2xl font-black text-white flex items-center gap-2">
            ...
            Ventas, Caja & Notas de Crédito
          </h2>
          <p className="text-xs text-slate-300">
            Control de comandas en vivo, registro de ventas del mes y emisión de devoluciones.
          </p>
        </div>
        ...
        <div className="flex items-center gap-1.5 p-1 rounded-2xl bg-white/5 border border-white/10">
          <button
            ...
            className={`px-3.5 py-1.5 rounded-xl text-xs font-bold transition-all tap-squish flex items-center gap-1.5 ${
                      ...
                      <div className="pt-3 border-t border-white/10 flex items-center justify-between gap-2 flex-wrap">
                        {isDelivered && (
                          ...
                          >
                            ...
                            <span>Emitir Nota de Crédito / Devolución</span>
                          </button>
                        )}
      ...
      {/* VIEW 2: FULL MONTH SALES & AUDIT REPORT */}
      {activeFinanceTab === 'monthly_sales' && (
      ...
      {/* VIEW 3: CREDIT NOTES & REFUNDS REGISTRY */}
      {activeFinanceTab === 'credit_notes' && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
          ...
          {creditNotes.length === 0 ? (
            <LiquidGlassCard variant="subtle" className="p-8 text-center">
              ...
              <p className="text-xs text-slate-500 mt-1">
                Puedes emitir una nota de crédito directamente desde cualquier comanda entregada en la pestaña "Comandas en Vivo".
              </p>
            </LiquidGlassCard>
          ) : (
      ...
      {/* MODAL 1: ISSUE CREDIT NOTE / REFUND */}
